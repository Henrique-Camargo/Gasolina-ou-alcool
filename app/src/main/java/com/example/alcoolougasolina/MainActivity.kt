...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var textResulltado: TextView
    ...
    private fun calcularMelhorPreco(){
        ...
        if ( resultadoValidacao ){
            ...
            if ( resultado >= 0.7 ){
                textResulltado.text = "Melhor usar gasolina!"
            }else {
                textResulltado.text = "Melhor usar Alcool!"
            }
    ...
    private fun validarCampos(pAlcool: String, pGasolina: String): Boolean {
        ...
        if (pAlcool.isEmpty()){
            textInputAlcool.error = "Digite preço do alcool!"
            return false
    ...
    private fun inicializarComponentesInterface() {
        ...
        textResulltado = findViewById( R.id.text_resultado )
    }
